...
# Update: This code contains AttitudeTarget message instead of the PositionTarget message
import rospy
...
if __name__ == "__main__":
    ...
    velocity_sub = rospy.Subscriber("mavros/local_position/velocity", TwistStamped, callback=velocity_cb) # can be used when controller is applied for velocities
